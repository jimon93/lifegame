...
(function() {
  var Builder, CanvasBuilder, CanvasVisitor, Cell, CellField, ConsoleBuilder, ConsoleVisitor, Director, LifeGame, Position, Rectangle, builder, director, extend, game, _ref, _ref1,
    __slice = [].slice,
